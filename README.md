...
Resampling genes: Sizes ranging from 10 to 50 

Results for each resampling size and number of resamples (n=10,000)
...
Shared and condition-specific rules for each tissue
